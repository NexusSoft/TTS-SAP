...
namespace GridControlEditCBMultipleSelection
{

    public class GridControlCheckMarksSelection
    {
        ...
        public GridControlCheckMarksSelection()
        {
        ...
        public GridControlCheckMarksSelection(GridView view)
            : this()
        {
            View = view;
        }
